...
# The WORKDIR is already ${WS_PATH}/src from the previous step
RUN git clone https://github.com/BehaviorTree/Groot.git
WORKDIR ${WS_PATH}/src/Groot
# Build and install Groot from source
...
RUN git clone https://github.com/MatheusFranca-dev/ugv_decision_manager.git
